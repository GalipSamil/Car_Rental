        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationAddress = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarTransmission = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CarFuel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CarMileage = table.Column<int>(type: "int", nullable: false),
                    CarDailyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CarLicencePlate = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverLicenceNo = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Profils", x => x.ProfilID);
                    table.ForeignKey(
                        name: "FK_Profils_Customers_CustomerID",
